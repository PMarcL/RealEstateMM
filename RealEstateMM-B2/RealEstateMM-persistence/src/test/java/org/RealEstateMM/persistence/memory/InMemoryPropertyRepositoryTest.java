...
public class InMemoryPropertyRepositoryTest {
	...
	// @Test
	// public void
	// givenANewRepositoryWhenAddinAPropertyThenTheSizeShouldIncrementAccordingly()
	// {
	...
	// public void
	// givenAnEmptyRepositoryWhenAddingTwiceTheSamePropertyThenAPropertyAlreadyAddedExceptionShouldBeThrown()
	// {
