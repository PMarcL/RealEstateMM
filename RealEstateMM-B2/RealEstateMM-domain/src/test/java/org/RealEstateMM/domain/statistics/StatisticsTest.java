...
public class StatisticsTest {
	...
	public void whenGetNumberOfActiveBuyerThenReturnsTheSizeOfTheFilteredList() {
		...
		given(userFilter.getUsersWithUserType(ALL_USERS, UserType.SELLER)).willReturn(BUYERS);
	...
	public void whenGetNumberOfActiveSellerThenReturnsTheSizeOfTheFilteredList() {
		...
		given(userFilter.getUsersWithUserType(ALL_USERS, UserType.SELLER)).willReturn(SELLERS);
