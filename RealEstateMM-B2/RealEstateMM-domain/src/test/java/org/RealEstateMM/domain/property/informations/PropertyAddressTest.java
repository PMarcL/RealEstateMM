...
public class PropertyAddressTest {
	...
	public void setup()
	{
		address = new PropertyAddress(AN_ADDRESS_STREET_NUMBER, AN_ADDRESS_STREET_NAME,
	...
	{
		PropertyAddress address2 = new PropertyAddress(AN_ADDRESS_STREET_NUMBER, AN_ADDRESS_STREET_NAME, AN_ADDRESS_CITY_NAME, AN_ADDRESS_PROVINCE_NAME, AN_ADDRESS_ZIP_CODE);
	...
	{
		PropertyAddress address2 = new PropertyAddress(AN_OTHER_ADDRESS_STREET_NUMBER, AN_ADDRESS_STREET_NAME, AN_OTHER_ADDRESS_CITY_NAME, AN_ADDRESS_PROVINCE_NAME, AN_ADDRESS_ZIP_CODE);
