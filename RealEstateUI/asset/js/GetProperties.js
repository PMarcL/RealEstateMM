...
function createHtmlPropertyList(propertiesJSON) {
    ...
    $.each(propertiesJSON, function () {
        ...
        buffer+= "<li class='propertylist-item'><div class='price'>" + this.propertyPrice + "</div>"
            + "<div class='type'>" + this.propertyType + "</div>"
            ...
            + "<div class='type'>" + this.propertyStatus + "</div>"
            + "<div class='type'>" + this.propertyOwner + "</div>"
            + "<li>";
